...
exec master..xp_cmdshell 'bcp "[WideWorldImporters].Sales.InvoiceLines" out  "E:\SQL WWI\InvoiceLines16.txt" -T -w -t"@eu&$1&" -S KRISTINAATWORK\MSSQLSERVER01'
...
DECLARE 
	...
	SET @path = 'E:\SQL WWI\';
	SET @FileName = 'InvoiceLines15.txt';
	/*******************************************************************/
	/*******************************************************************/
	/*******************************************************************/
...
BULK INSERT [WideWorldImporters].[Sales].[InvoiceLines_BulkDemo]
   FROM "E:\SQL WWI\InvoiceLines16.txt"
   WITH 
	 (
		BATCHSIZE = 1000, 
		DATAFILETYPE = 'widechar',
