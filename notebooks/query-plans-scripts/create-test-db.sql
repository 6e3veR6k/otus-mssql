CREATE DATABASE [application]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'application', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\application.mdf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'application_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\application_log.ldf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
...
GO
ALTER DATABASE [application] SET AUTO_CREATE_STATISTICS ON(INCREMENTAL = OFF)
GO
...
FROM sys.filegroups
WHERE is_default=1 AND name = N'PRIMARY') ALTER DATABASE [application] MODIFY FILEGROUP [PRIMARY] DEFAULT
GO
